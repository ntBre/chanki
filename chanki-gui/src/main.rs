mod app {
    ...
    impl eframe::App for TemplateApp {
        ...
        fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
            ...
            // Examples of how to create different panels and windows. Pick
            // whichever suits you. Tip: a good default choice is to just keep
            // the `CentralPanel`. For inspiration and more examples, go to
...
fn main() -> eframe::Result<()> {
    ...
    eframe::run_native(
        "eframe template",
        native_options,
        Box::new(|_| Box::new(app::TemplateApp::new())),
    )
}
